...
# Budget Guard — batmayalım
MAX_API_SPEND_USD   = 3.0    # bu limiti geçince dur
COST_PER_CALL_USD   = 0.00025  # Haiku ~0.00025$ / call (input+output ortalama)
BUDGET_WARN_AT_USD  = 2.0    # bu noktada uyar
